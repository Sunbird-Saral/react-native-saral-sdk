...
**After scanning, the scan result screen will open, in which the information according to the layout type will be visible.** You can follow this path to see the scan output screen `https://github.com/Sunbird-Saral/react-native-saral-sdk/blob/SS-19-post-scan/example/SaralDemo/src/ScanDetailScreen.js`
